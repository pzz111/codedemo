...
public class SysUserController extends BaseController {
    ...
    @ApiOperation("新增用户")
    @PostMapping("/save")
    public ResultVO<Void> saveSysUser(@RequestBody SysUserVO sysUserVO) throws Exception {
    ...
    public ResultVO<Void> saveSysUserBatch(@RequestBody List<SysUserVO> sysUserVOList) throws Exception {
        return this.sysUserService.saveSysUserBatch(sysUserVOList);
    }
    ...
    @ResponseBody
    public ResultVO<SysUserVO> selectSysUserVO(@RequestParam(value = "id", required = false) String id) throws Exception {
        return this.sysUserService.selectSysUserVO(id);
    }
