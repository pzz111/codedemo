...
public interface SysUserService {
     ...
     * @throws Exception
     */
    ResultVO<Void> saveSysUser(SysUserVO sysUserVO) throws Exception;
     ...
     * @throws Exception
     */
    ResultVO<Void> saveSysUserBatch(List<SysUserVO> sysUserVO) throws Exception;
     ...
     * @throws Exception
     */
    ResultVO<SysUserVO> selectSysUserVO(String id) throws Exception;
