...
public class SysUserServiceImpl implements SysUserService {
    ...
    @Transactional
    @Override
    public ResultVO<Void> saveSysUser(SysUserVO sysUserVO) throws Exception {
        ...
        return ResultVO.getSuccess("添加用户成功");
    }


    @Transactional
    @Override
    public ResultVO<Void> saveSysUserBatch(List<SysUserVO> sysUserVOList) throws Exception {
    ...
    @Override
    public ResultVO<SysUserVO> selectSysUserVO(String id) throws Exception {

        SysUserVO newSysUserVO = this.sysUserMapper.selectSysUserVO(id);
